...
// =============================================================================
export const TWLEX001 = {
    code: 'TWLEX001',
    description: "You're mixing tabs and spaces for indentation. TinyWhale needs one or the other to understand your code structure.",
    message: 'mixed tabs and spaces',
    severity: DiagnosticSeverity.Error,
    suggestion: 'Pick either tabs or spaces and stick with it for the whole file.',
};
export const TWLEX002 = {
    code: 'TWLEX002',
    description: 'Your first indent used {unit} spaces, so TinyWhale expects all indents to be multiples of {unit}.',
...
export const TWLEX005 = {
    code: 'TWLEX005',
    description: 'This file started with {expected}, so TinyWhale expects you to keep using {expected} throughout.',
...
// =============================================================================
export const TWCHECK001 = {
    code: 'TWCHECK001',
    description: 'Indented code needs to be inside something like a function. Right now, TinyWhale only supports top-level statements.',
    message: 'unexpected indentation',
    severity: DiagnosticSeverity.Error,
    suggestion: 'Remove the indentation, or wrap this code in a function when that feature is available.',
};
// =============================================================================
// CHECKER WARNINGS (TWCHECK050-099)
// =============================================================================
export const TWCHECK050 = {
    code: 'TWCHECK050',
    description: 'This code will never run because something above it (like `panic`) always exits first.',
